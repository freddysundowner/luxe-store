...
export function RootLayout({ children, title, showBack }: { children: ReactNode; title?: string; showBack?: boolean }) {
  ...
  return (
    <div className="min-h-[100dvh] flex flex-col bg-background max-w-md mx-auto relative shadow-xl overflow-hidden">
      <header className="sticky top-0 z-50 bg-primary text-primary-foreground shadow-md px-4 py-3 flex items-center justify-between">
